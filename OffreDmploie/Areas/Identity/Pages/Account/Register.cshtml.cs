...
namespace OffreDmploie.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Nometprenom = Input.Nometprenom;

                user.PhoneNumber = Input.PhoneNumber;
                user.Nomdentreprise = Input.Nomdentreprise;
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // Confirmation directe par l'admin
